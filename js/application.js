          ...
          , a = {
            ...
            triggerAllAnimationEndEvent: function(e, i) {
                ...
                var n = 0
                  ...
                  , o = "allanimationend"
                  , l = function(i) {
                    t(i.delegateTarget).is(e) && (i.stopPropagation(),
                    n++)
                }
                  , u = function(i) {
                    t(i.delegateTarget).is(e) && (i.stopPropagation(),
          ...
          , u = function(o, l) {
            var u = t(o)
              ...
              , g = function(e, i) {
                i = i || t.noop;
                var n = a.translate(e);
                if (p = a.clearIfOverCapacity(p, l.cacheLength),
              ...
              , x = function(e) {
                ...
                a.shouldLoadAnchor(n, l.blacklist, l.hrefRegex) && !f && (e.stopPropagation(),
              ...
              , w = function(e) {
                ...
                if (!e.metaKey && !e.ctrlKey && a.shouldLoadAnchor(i, l.blacklist, l.hrefRegex) && (e.stopPropagation(),
                e.preventDefault(),
                !z())) {
                    P();
              ...
              , b = function(e) {
                var i = t(e.currentTarget);
                if (!i.is(l.blacklist) && (e.preventDefault(),
                e.stopPropagation(),
                !z())) {
                    P();
                    var r = {
              ...
              , k = function(t) {
                l.anchors && (t.on("click", l.anchors, w),
                O(t)),
            ...
            null === e.history.state ? (d = l.alterChangeState({
                id: h
            }, i.title, m),
            e.history.replaceState(d, i.title, m)) : d = {},
            a.storePageIn(p, m, i.documentElement.outerHTML, h, d),
            a.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"),
            k(u),
            {
                href: m,
                cache: p,
...
!function(t, e, i) {
        ...
        for (var l in h)
            if (h.hasOwnProperty(l)) {
                ...
                s = 0; s < t.length; s++)
                    o = t[s],
                    a = o.split("."),
                    1 === a.length ? f[a[0]] = r : (!f[a[0]] || f[a[0]]instanceof Boolean || (f[a[0]] = new Boolean(f[a[0]])),
                    f[a[0]][a[1]] = r),
                    u.push((r ? "" : "no-") + a.join("-"))
            }
    }
    function s(t) {
        ...
        if (d && (e = e.baseVal),
        f._config.enableJSClass) {
            var n = new RegExp("(^|\\s)" + i + "no-js(\\s|$)");
            e = e.replace(n, "$1" + i + "js$2")
        }
        f._config.enableClasses && (e += " " + i + t.join(" " + i),
    ...
    function l(t, i, n, r) {
        ...
        p.style.overflow = h,
        p.offsetHeight) : f.parentNode.removeChild(f),
        !!l
    }
    var u = []
      , h = []
...
!function(t, e) {
    ...
    if (!n.TweenLite) {
        var r, s, o, a, l, u = function(t) {
            ...
            this.check = function(h) {
                for (var c, f, p, d, g, _ = s.length, v = _; --_ > -1; )
                    (c = m[s[_]] || new R(s[_],[])).gsClass ? (l[_] = c.gsClass,
                    v--) : h && c.sc.push(this);
                if (0 === v && o) {
        ...
        s = r.length; --s > -1; )
            ...
            b(new x(null,null,2,s), o, "easeIn" + (0 === s ? ",easeNone" : "")),
        ...
        o.addEventListener = function(t, e, i, n, r) {
            ...
            o = u.length; --o > -1; )
                s = u[o],
                s.c === e && s.s === i ? u.splice(o, 1) : 0 === h && s.pr < r && (h = o + 1);
            u.splice(h, 0, {
                c: e,
                s: i,
                up: n,
        ...
        s = r.length; --s > -1 && !z; )
            ...
            P = t[r[s] + "CancelAnimationFrame"] || t[r[s] + "CancelRequestAnimationFrame"];
        _("Ticker", function(t, e) {
            var i, n, r, s, o, u = this, h = O(), f = !(e === !1 || !z) && "auto", d = 500, m = 33, R = "tick", g = function(t) {
                var e, a, l = O() - k;
                l > d && (h += l - m),
                k += l,
                u.time = (k - h) / 1e3,
            ...
            ,
            u.wake = function(t) {
                null !== r ? u.sleep() : t ? h += -k + (k = O()) : u.frame > 10 && (k = O() - d + 5),
                n = 0 === i ? p : f && z ? z : function(t) {
        ...
        o.totalTime = function(t, e, i) {
            ...
            if (this._timeline) {
                ...
                (this._totalTime !== t || 0 === this._duration) && (F.length && Z(),
                this.render(t, e, !1),
                F.length && Z())
            }
            return this
        ...
        var E = _("TweenLite", function(e, i, n) {
            ...
            (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
                ...
                r = 0; r < o.length; r++)
                    ...
                    this._targets = o = o.concat(f(s))) : (this._siblings[r] = $(s, this, !1),
                    1 === l && this._siblings[r].length > 1 && J(s, this, null, 1, this._siblings[r])) : (s = o[r--] = E.selector(s),
        ...
        var F = []
          ...
          , X = function(t, e, i, n) {
            ...
            a = 0; l > a; a++)
                ...
                h === r[a] || r.length <= a ? p += h : (p && (c.push(p),
                p = ""),
                o = parseFloat(r[a]),
                c.push(o),
                c._firstPT = {
          ...
          , D = function(t, e, i, n, r, s, o, a) {
            ...
            return "number" !== c && ("function" === c && "get" === i && (u = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3),
            p.s = h = o ? t[u](o) : t[u]()),
            "string" == typeof h && (o || isNaN(h)) ? (p.fp = o,
        ...
        setTimeout(Z, 1),
        C._updateRoot = E.render = function() {
            var t, e, i;
            if (F.length && Z(),
            ...
            a.frame >= Q) {
                ...
                if (i = H._first,
                (!i || i._paused) && E.autoSleep && !W._first && 1 === a._listeners.tick.length) {
                    for (; i && i._paused; )
                        i = i._next;
                    i || a.sleep()
                }
        ...
        var $ = function(t, e, i) {
          ...
          , J = function(t, e, i, n, r) {
            ...
            for (s = r.length; --s > -1; )
                (a = r[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (u = u || tt(e, 0, d),
                0 === tt(a, u, d) && (f[p++] = a)) : a._startTime <= h && a._startTime + a.totalDuration() / a._timeScale > h && ((d || !a._initted) && h - a._startTime <= 2e-10 || (f[p++] = a)));
            for (s = p; --s > -1; )
                if (a = f[s],
        ...
        o._init = function() {
            ...
            if (this._ease = u = u ? u instanceof x ? u : "function" == typeof u ? new x(u,s.easeParams) : w[u] || E.defaultEase : E.defaultEase,
        ...
        o._initProps = function(e, i, n, r) {
            ...
            if (null == e)
                return !1;
            I[e._gsTweenID] && Z(),
            this.vars.css || e.style && e !== t && e.nodeType && V.css && this.vars.autoCSS !== !1 && N(this.vars, e);
            for (s in this.vars)
                if (h = this.vars[s],
                q[s])
                    ...
                    i[s] = D.call(this, e, s, "get", h, s, 0, null, this.vars.stringFilter);
            return r && this._kill(r, e) ? this._initProps(e, i, n, r) : this._overwrite > 1 && this._firstPT && n.length > 1 && J(e, this, i, this._overwrite, n) ? (this._kill(i, e),
        ...
        o.render = function(t, e, i) {
            ...
            if (t >= l - 1e-7)
                ...
                (0 > u || 0 >= t && t >= -1e-7 || u === c && "isPause" !== this.data) && u !== t && (i = !0,
                ...
                n = this._reversed),
                0 > t && (this._active = !1,
                0 === l && (this._initted || !this.vars.lazy || i) && (u >= 0 && (u !== c || "isPause" !== this.data) && (i = !0),
                this._rawPrevTime = o = !e || t || u === t ? t : c)),
                this._initted || (i = !0);
            ...
            this._easeType) {
                ...
                1 === f ? this.ratio = 1 - h : 2 === f ? this.ratio = h : .5 > t / l ? this.ratio = h / 2 : this.ratio = 1 - h / 2
            } else
        ...
        r = t._gsQueue) {
            for (s = 0; s < r.length; s++)
                r[s]();
            for (o in m)
                m[o].func || t.console.log("GSAP encountered missing dependency: com.greensock." + o)
        }
        l = !1
    }
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var h, c, f, p, d, m, R = /(?:\-|\.|\b)(\d|\.|e\-)+/g, g = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, _ = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, y = /(?:\d|\-|\+|=|#|\.)*/g, x = /opacity *= *([^)]*)/i, w = /opacity:([^;]*)/i, b = /alpha\(opacity *=.+?\)/i, T = /^(rgb|hsl)/, z = /([A-Z])/g, P = /-([a-z])/gi, O = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, k = function(t, e) {
            return e.toUpperCase()
        }, C = /(?:Left|Right|Width)/i, S = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, A = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, E = /,(?=[^\)]*(?:\(|$))/gi, M = /[\s,\(]/i, N = Math.PI / 180, F = 180 / Math.PI, I = {}, L = document, j = function(t) {
            return L.createElementNS ? L.createElementNS("http://www.w3.org/1999/xhtml", t) : L.createElement(t)
        }, X = j("div"), D = j("img"), Y = o._internals = {
            _specialProps: l
        }, V = navigator.userAgent, B = function() {
        ...
        , Z = o.getStyle = function(t, e, i, n, r) {
            var s;
            return B || "opacity" !== e ? (!n && t.style[e] ? s = t.style[e] : (i = i || Q(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(z, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]),
        ...
        , $ = Y.convertToPixels = function(t, i, n, r, s) {
            ...
            if ("auto" === r || !n)
                return 0;
            var a, l, u, h = C.test(i), c = t, f = X.style, p = 0 > n, d = 1 === n;
            if (p && (n = -n),
            d && (n *= 100),
            "%" === r && -1 !== i.indexOf("border"))
                a = n / 100 * (h ? t.clientWidth : t.clientHeight);
            else {
                if (f.cssText = "border:0 solid red;position:" + Z(t, "position") + ";line-height:0;",
                "%" !== r && c.appendChild && "v" !== r.charAt(0) && "rem" !== r)
                    f[h ? "borderLeftWidth" : "borderTopWidth"] = n + r;
                else {
                    if (c = t.parentNode || L.body,
                    l = c._gsCache,
                    u = e.ticker.frame,
                    l && h && l.time === u)
                ...
                c.removeChild(X),
                h && "%" === r && o.cacheWidths !== !1 && (l = c._gsCache = c._gsCache || {},
                l.time = u,
                l.width = a / n * 100),
                0 !== a || s || (a = $(t, i, n, r, !0))
            }
        ...
        , J = function(t, e) {
            ...
            if (e = e || Q(t, null))
                if (i = e.length)
                    for (; --i > -1; )
                        r = e[i],
                        (-1 === r.indexOf("-transform") || Pt === r) && (s[r.replace(P, k)] = e.getPropertyValue(r));
                else
                    for (i in e)
                        (-1 === i.indexOf("Transform") || zt === i) && (s[i] = e[i]);
            else if (e = t.currentStyle || t.style)
                for (i in e)
                    "string" == typeof i && void 0 === s[i] && (s[i.replace(P, k)] = e[i]);
            return B || (s.opacity = U(t)),
            n = Xt(t, e, !1),
            ...
            for (o in i)
                "cssText" !== o && "length" !== o && isNaN(o) && (e[o] !== (s = i[o]) || r && r[o]) && -1 === o.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[o] = "auto" !== s || "left" !== o && "top" !== o ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[o] || "" === e[o].replace(v, "") ? s : 0 : K(t, o),
            ...
            s = t.split("_"),
            l = "=" === t.charAt(1),
            o = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : F) - (l ? 0 : e),
            s.length && (n && (n[i] = e + o),
            ...
            u === h ? o = a = 0 : (c = u - h,
            a = l > .5 ? c / (2 - u - h) : c / (u + h),
            o = u === n ? (r - s) / c + (s > r ? 6 : 0) : u === r ? (s - n) / c + 2 : (n - r) / c + 4,
            o *= 60),
            i[0] = o + .5 | 0,
            i[1] = 100 * a + .5 | 0,
            i[2] = 100 * l + .5 | 0),
        ...
        Y.CSSPropTween = function(t, e, n, r, o, a, l, u, h, c, f) {
          ...
          , _t = o.parseComplex = function(t, e, i, n, r, s, a, l, u, c) {
            ...
            i = n[0],
            n = n[1]);
            var f, p, d, m, _, v, y, x, w, b, T, z, P, O = i.split(", ").join(",").split(" "), k = n.split(", ").join(",").split(" "), C = O.length, S = h !== !1;
            for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (O = O.join(" ").replace(E, ", ").split(" "),
            k = k.join(" ").replace(E, ", ").split(" "),
            C = O.length),
            C !== k.length && (O = (s || "").split(" "),
            C = O.length),
            a.plugin = u,
            a.setRatio = c,
            ft.lastIndex = 0,
            f = 0; C > f; f++)
                ...
                x = parseFloat(m),
                x || 0 === x)
                    a.appendXtra("", x, st(_, x), _.replace(g, ""), S && -1 !== _.indexOf("px"), !0);
                else if (r && ft.test(m))
                    z = _.indexOf(")") + 1,
                    z = ")" + (z ? _.substr(z) : ""),
                    P = -1 !== _.indexOf("hsl") && B,
                    ...
                    w && !B && 0 === _[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent",
                    a.e = a.e.split(k[f]).join("transparent")) : (B || (w = !1),
                    P ? a.appendXtra(w ? "hsla(" : "hsl(", m[0], st(_[0], m[0]), ",", !1, !0).appendXtra("", m[1], st(_[1], m[1]), "%,", !1).appendXtra("", m[2], st(_[2], m[2]), w ? "%," : "%" + z, !1) : a.appendXtra(w ? "rgba(" : "rgb(", m[0], _[0] - m[0], ",", !0, !0).appendXtra("", m[1], _[1] - m[1], ",", !0).appendXtra("", m[2], _[2] - m[2], w ? "," : z, !0),
                    w && (m = m.length < 4 ? 1 : m[3],
                    a.appendXtra("", m, (_.length < 4 ? 1 : _[3]) - m, z, !1))),
                    ft.lastIndex = 0;
                else if (v = m.match(R)) {
                    if (y = _.match(g),
                    !y || y.length !== v.length)
                    ...
                    p = 0; p < v.length; p++)
                        T = v[p],
                        b = m.indexOf(T, d),
                        a.appendXtra(m.substr(d, b - d), Number(T), st(y[p], T), "", S && "px" === m.substr(b + T.length, 2), 0 === p),
                        d = b + T.length;
                    a["xs" + a.l] += m.substr(d)
                } else
                    a["xs" + a.l] += a.l || a["xs" + a.l] ? " " + _ : _;
            if (-1 !== n.indexOf("=") && a.data) {
                for (z = a.xs0 + a.data.s,
                f = 1; f < a.l; f++)
        ...
        u.appendXtra = function(t, e, i, n, r, s) {
            ...
            o.rxp["xn" + a] = r,
            o["xn" + a] = e,
            o.plugin || (o.xfirst = new Rt(o,"xn" + a,e,i,o.xfirst || o,0,o.n,r,o.pr),
            o.xfirst.xs0 = 0),
            o) : (o.data = {
                s: e + i
            },
            ...
            if (!l[t]) {
                ...
                xt(t, {
                    parser: function(t, i, n, r, s, o, u) {
                        ...
                        l[n].parse(t, i, n, r, s, o, u)) : (q("Error: " + e + " js file not loaded."),
                        s)
                    }
                })
            }
        ...
        u.parseComplex = function(t, e, i, n, r, s) {
            ...
            if (this.multi && (E.test(i) || E.test(e) ? (a = e.replace(E, "|").split("|"),
            l = i.replace(E, "|").split("|")) : f && (a = [e],
            l = [i])),
            l) {
                ...
                o = 0; u > o; o++)
                    ...
                    f && (h = e.indexOf(f),
                    c = i.indexOf(f),
                    h !== c && (-1 === c ? a[o] = a[o].split(f).join("") : -1 === h && (a[o] += " " + f)));
                e = a.join(", "),
                i = l.join(", ")
            }
        ...
        var bt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), zt = H("transform"), Pt = G + "transform", Ot = H("transformOrigin"), kt = null !== H("perspective"), Ct = Y.Transform = function() {
            this.perspective = parseFloat(o.defaultTransformPerspective) || 0,
            this.force3D = !(o.defaultForce3D === !1 || !kt) && (o.defaultForce3D || "auto")
        }
        , St = window.SVGElement, At = function(t, e, i) {
            ...
            r
        }, Et = L.documentElement, Mt = function() {
            var t, e, i, n = m || /Android/i.test(V) && !window.chrome;
            return L.createElementNS && !n && (t = At("svg", Et),
            e = At("rect", t, {
                width: 100,
                height: 50,
                x: 100
            ...
            var a, l, u, h, c, f, p, d, m, R, g, _, v, y, x = t._gsTransform, w = jt(t, !0);
            x && (v = x.xOrigin,
            y = x.yOrigin),
            ...
            i.yOffset = x.yOffset,
            x = i),
            r || r !== !1 && o.defaultSmoothOrigin !== !1 ? (l = h - v,
            u = c - y,
            ...
            o && Et.removeChild(t)),
            (l.svg || t.getBBox && It(t)) && (i && -1 !== (h[zt] + "").indexOf("matrix") && (n = h[zt],
            i = 0),
            ...
            vt = r.length; --vt > -1; )
                s = Number(r[vt]),
                r[vt] = (o = s - (s |= 0)) ? (o * u + (0 > o ? -.5 : .5) | 0) / u + s : s;
            return e && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r
        }, Xt = Y.getTransform = function(t, i, n, r) {
            if (t._gsTransform && n && !r)
                return t._gsTransform;
            var s, a, l, u, h, c, f = n ? t._gsTransform || new Ct : new Ct, p = f.scaleX < 0, d = 2e-5, m = 1e5, R = kt ? parseFloat(Z(t, Ot, i, !1, "0 0 0").split(" ")[2]) || f.zOrigin || 0 : 0, g = parseFloat(o.defaultTransformPerspective) || 0;
            if (f.svg = !(!t.getBBox || !It(t)),
            f.svg && (Nt(t, Z(t, Ot, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")),
            bt = o.useSVGTransformAttr || Mt),
            s = jt(t),
            s !== Lt) {
                if (16 === s.length) {
                    var _, v, y, x, w, b = s[0], T = s[1], z = s[2], P = s[3], O = s[4], k = s[5], C = s[6], S = s[7], A = s[8], E = s[9], M = s[10], N = s[12], I = s[13], L = s[14], j = s[11], X = Math.atan2(C, M);
                    ...
                    f.scaleX = (Math.sqrt(b * b + T * T) * m + .5 | 0) / m,
                    f.scaleY = (Math.sqrt(k * k + E * E) * m + .5 | 0) / m,
                    f.scaleZ = (Math.sqrt(C * C + M * M) * m + .5 | 0) / m,
                    f.rotationX || f.rotationY ? f.skewX = 0 : (f.skewX = O || k ? Math.atan2(O, k) * F + f.rotation : f.skewX || 0,
                    ...
                    f.y = I,
                    f.z = L,
                    f.svg && (f.x -= f.xOrigin - (f.xOrigin * b - f.yOrigin * O),
                    ...
                    f.rotation = h,
                    f.skewX = c,
                    kt && (f.rotationX = f.rotationY = f.z = 0,
                    f.perspective = g,
                    f.scaleZ = 1),
                    f.svg && (f.x -= f.xOrigin - (f.xOrigin * Y + f.yOrigin * B),
            ...
            f.svg && (bt && t.style[zt] ? e.delayedCall(.001, function() {
                Bt(t.style, zt)
        ...
        , Dt = function(t) {
            ...
            if (f) {
                ...
                if (null != n.ox && (p = (n.oxp ? R * n.ox * .01 : n.ox) - R / 2,
                d = (n.oyp ? g * n.oy * .01 : n.oy) - g / 2,
                w += p - (p * a + d * l),
                b += d - (p * u + d * h)),
                _ ? (p = R / 2,
                d = g / 2,
                v += ", Dx=" + (p - (p * a + d * l) + w) + ", Dy=" + (d - (p * u + d * h) + b) + ")") : v += ", sizingMethod='auto expand')",
                -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? c.filter = e.replace(A, v) : c.filter = v + " " + e,
                (0 === t || 1 === t) && 1 === a && 0 === l && 0 === u && 1 === h && (_ && -1 === v.indexOf("Dx=0, Dy=0") || x.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && c.removeAttribute("filter")),
                !_) {
                    var T, z, P, O = 8 > m ? 1 : -1;
                    for (p = n.ieOffsetX || 0,
                    d = n.ieOffsetY || 0,
                    n.ieOffsetX = Math.round((R - ((0 > a ? -a : a) * R + (0 > l ? -l : l) * g)) / 2 + w),
                    n.ieOffsetY = Math.round((g - ((0 > h ? -h : h) * g + (0 > u ? -u : u) * R)) / 2 + b),
                    vt = 0; 4 > vt; vt++)
                        z = it[vt],
                        T = f[z],
                        i = -1 !== T.indexOf("px") ? parseFloat(T) : $(this.t, z, parseFloat(T), T.replace(y, "")) || 0,
                        P = i !== n[z] ? 2 > vt ? -n.ieOffsetX : -n.ieOffsetY : 2 > vt ? p - n.ieOffsetX : d - n.ieOffsetY,
                        c[z] = (n[z] = Math.round(i - P * (0 === vt || 2 === vt ? 1 : O))) + "px"
                }
            }
        }, Yt = Y.set3DTransformRatio = Y.setTransformRatio = function(t) {
            var e, i, n, r, s, o, a, l, u, h, c, f, d, m, R, g, _, v, y, x, w, b, T, z = this.data, P = this.t.style, O = z.rotation, k = z.rotationX, C = z.rotationY, S = z.scaleX, A = z.scaleY, E = z.scaleZ, M = z.x, F = z.y, I = z.z, L = z.svg, j = z.perspective, X = z.force3D;
            if (((1 === t || 0 === t) && "auto" === X && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !X) && !I && !j && !C && !k && 1 === E || bt && L || !kt)
                return void (O || z.skewX || L ? (O *= N,
                b = z.skewX * N,
                T = 1e5,
                e = Math.cos(O) * S,
                r = Math.sin(O) * S,
                i = Math.sin(O - b) * -A,
                s = Math.cos(O - b) * A,
                b && "simple" === z.skewType && (_ = Math.tan(b),
                _ = Math.sqrt(1 + _ * _),
                i *= _,
                s *= _,
                z.skewY && (e *= _,
                r *= _)),
                L && (M += z.xOrigin - (z.xOrigin * e + z.yOrigin * i) + z.xOffset,
                F += z.yOrigin - (z.xOrigin * r + z.yOrigin * s) + z.yOffset,
                bt && (z.xPercent || z.yPercent) && (m = this.t.getBBox(),
                M += .01 * z.xPercent * m.width,
                F += .01 * z.yPercent * m.height),
                m = 1e-6,
                m > M && M > -m && (M = 0),
                m > F && F > -m && (F = 0)),
                y = (e * T | 0) / T + "," + (r * T | 0) / T + "," + (i * T | 0) / T + "," + (s * T | 0) / T + "," + M + "," + F + ")",
                L && bt ? this.t.setAttribute("transform", "matrix(" + y) : P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix(" : "matrix(") + y) : P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix(" : "matrix(") + S + ",0,0," + A + "," + M + "," + F + ")");
            if (p && (m = 1e-4,
            m > S && S > -m && (S = E = 2e-5),
            m > A && A > -m && (A = E = 2e-5),
            ...
            O || z.skewX)
                ...
                R = Math.cos(O),
                g = Math.sin(O),
                "simple" === z.skewType && (_ = Math.tan(z.skewX * N),
                _ = Math.sqrt(1 + _ * _),
                R *= _,
                g *= _,
                z.skewY && (e *= _,
                ...
                if (!(C || k || 1 !== E || j || L))
                    return void (P[zt] = (z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) translate3d(" : "translate3d(") + M + "px," + F + "px," + I + "px)" + (1 !== S || 1 !== A ? " scale(" + S + "," + A + ")" : ""));
                e = s = 1,
                i = r = 0
            }
            u = 1,
            ...
            m > F && F > -m && (F = w),
            m > I && I > -m && (I = 0)),
            y = z.xPercent || z.yPercent ? "translate(" + z.xPercent + "%," + z.yPercent + "%) matrix3d(" : "matrix3d(",
            y += (m > e && e > -m ? w : e) + x + (m > r && r > -m ? w : r) + x + (m > a && a > -m ? w : a),
            y += x + (m > h && h > -m ? w : h) + x + (m > i && i > -m ? w : i) + x + (m > s && s > -m ? w : s),
            k || C || 1 !== E ? (y += x + (m > l && l > -m ? w : l) + x + (m > c && c > -m ? w : c) + x + (m > n && n > -m ? w : n),
            y += x + (m > o && o > -m ? w : o) + x + (m > u && u > -m ? w : u) + x + (m > f && f > -m ? w : f) + x) : y += ",0,0,0,0,1,0,",
        ...
        xt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(t, e, i, n, s, a, l) {
                ...
                var u, h, c, f, p, d, m, R, g, _ = t._gsTransform, v = t.style, y = 1e-6, x = Tt.length, w = l, b = {}, T = "transformOrigin", z = Xt(t, r, !0, l.parseTransform);
                if (n._transform = z,
                "string" == typeof w.transform && zt)
                    h = X.style,
                    h[zt] = w.transform,
                    h.display = "block",
                    h.position = "absolute",
                    ...
                    Nt(t, rt(w.transformOrigin), c, w.svgOrigin, w.smoothOrigin, !0),
                    m = c.xOrigin,
                    R = c.yOrigin,
                    ...
                    null != w.xPercent && (u.xPercent = ot(w.xPercent, z.xPercent)),
                    null != w.yPercent && (u.yPercent = ot(w.yPercent, z.yPercent));
                    ...
                    u.xPercent = ot(w.x, z.xPercent)),
                    "string" == typeof w.y && -1 !== w.y.indexOf("%") && (u.y = 0,
                    u.yPercent = ot(w.y, z.yPercent)),
                    u.rotation = at("rotation"in w ? w.rotation : "shortRotation"in w ? w.shortRotation + "_short" : "rotationZ"in w ? w.rotationZ : z.rotation - z.skewY, z.rotation - z.skewY, "rotation", b),
                    kt && (u.rotationX = at("rotationX"in w ? w.rotationX : "shortRotationX"in w ? w.shortRotationX + "_short" : z.rotationX || 0, z.rotationX, "rotationX", b),
                    u.rotationY = at("rotationY"in w ? w.rotationY : "shortRotationY"in w ? w.shortRotationY + "_short" : z.rotationY || 0, z.rotationY, "rotationY", b)),
                    u.skewX = at(w.skewX, z.skewX - z.skewY),
                    (u.skewY = at(w.skewY, z.skewY)) && (u.skewX += u.skewY,
                    u.rotation += u.skewY)
                }
                for (kt && null != w.force3D && (z.force3D = w.force3D,
                p = !0),
                z.skewType = w.skewType || z.skewType || o.defaultSkewType,
                f = z.force3D || z.z || z.rotationX || z.rotationY || u.z || u.rotationX || u.rotationY || u.perspective,
                f || null == w.scale || (u.scaleZ = 1); --x > -1; )
                    i = Tt[x],
                    c = u[i] - z[i],
                    (c > y || -y > c || null != w[i] || null != I[i]) && (p = !0,
                ...
                z.svg && (c || w.svgOrigin) && (m = z.xOffset,
                R = z.yOffset,
                ...
                (m !== z.xOffset || R !== z.yOffset) && (s = gt(z, "xOffset", _ ? m : z.xOffset, z.xOffset, s, T),
                s = gt(z, "yOffset", _ ? R : z.yOffset, z.yOffset, s, T)),
                c = bt ? null : "0px 0px"),
                (c || kt && f && z.zOrigin) && (zt ? (p = !0,
                i = Ot,
                c = (c || Z(t, i, r, !1, "50% 50%")) + "",
                ...
                kt ? (h = z.zOrigin,
                c = c.split(" "),
                z.zOrigin = (c.length > 2 && (0 === h || "0px" !== c[2]) ? parseFloat(c[2]) : h) || 0,
                s.xs0 = s.e = c[0] + " " + (c[1] || "50%") + " 0px",
                s = new Rt(z,"zOrigin",0,0,s,(-1),s.n),
                s.b = h,
                s.xs0 = s.e = z.zOrigin) : s.xs0 = s.e = c) : rt(c + "", z)),
                p && (n._transformType = z.svg && bt || !f && 3 !== this._transformType ? 2 : 3),
                s
            },
            prefix: !0
        }),
        ...
        xt("borderRadius", {
            ...
            parser: function(t, e, i, s, o, a) {
                ...
                for (R = parseFloat(t.offsetWidth),
                ...
                u = 0; u < T.length; u++)
                    ...
                    v = f.substr((d + "").length),
                    y = "=" === p.charAt(1),
                    y ? (m = parseInt(p.charAt(0) + "1", 10),
                    p = p.substr(2),
                    m *= parseFloat(p),
                    _ = p.substr((m + "").length - (0 > m ? 1 : 0)) || "") : (m = parseFloat(p),
                    _ = p.substr((m + "").length)),
                    "" === _ && (_ = n[i] || v),
                    _ !== v && (x = $(t, "borderLeft", d, v),
                    w = $(t, "borderTop", d, v),
                    "%" === _ ? (f = x / R * 100 + "%",
                    c = w / g * 100 + "%") : "em" === _ ? (b = $(t, "borderLeft", 1, "em"),
                    f = x / b + "em",
                    c = w / b + "em") : (f = x + "px",
                    c = w + "px"),
                    y && (p = parseFloat(f) + m + _,
                    h = parseFloat(c) + m + _)),
        ...
        xt("backgroundPosition", {
            ...
            parser: function(t, e, i, n, s, o) {
                ...
                if (-1 !== R.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && (f = Z(t, "backgroundImage").replace(O, ""),
                f && "none" !== f)) {
                    for (a = R.split(" "),
                    l = g.split(" "),
                    ...
                    u = 2; --u > -1; )
                        R = a[u],
                        h = -1 !== R.indexOf("%"),
                        h !== (-1 !== l[u].indexOf("%")) && (c = 0 === u ? t.offsetWidth - D.width : t.offsetHeight - D.height,
                        a[u] = h ? parseFloat(R) / 100 * c + "px" : parseFloat(R) / c * 100 + "%");
                    R = a.join(" ")
                }
        ...
        xt("clip", {
            ...
            parser: function(t, e, i, n, s, o) {
                ...
                e = this.format(e).split(",").join(u)) : (a = this.format(Z(t, this.p, r, !1, this.dflt)),
                e = this.format(e)),
        ...
        xt("border", {
            ...
            parser: function(t, e, i, n, s, o) {
                var a = Z(t, "borderTopWidth", r, !1, "0px")
                  ...
                  , u = l[0].replace(y, "");
                return "px" !== u && (a = parseFloat(a) / $(t, "borderTopWidth", 1, u) + u),
                this.parseComplex(t.style, this.format(a + " " + Z(t, "borderTopStyle", r, !1, "solid") + " " + Z(t, "borderTopColor", r, !1, "#000")), l.join(" "), s, o)
            },
            color: !0,
        ...
        var Vt = function(t) {
            ...
            e = !Z(this.data, "filter")) : (i.filter = n.replace(b, ""),
            e = !0)),
        ...
        xt("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, n, s, o) {
                ...
                u && 1 === a && "hidden" === Z(t, "visibility", r) && 0 !== e && (a = 0),
                B ? s = new Rt(l,"opacity",a,e - a,s) : (s = new Rt(l,"opacity",100 * a,100 * (e - a),s),
                s.xn1 = u ? 1 : 0,
                l.zoom = 1,
                s.type = 2,
                ...
                s.plugin = o,
                s.setRatio = Vt),
                u && (s = new Rt(l,"visibility",0,0,s,(-1),null,(!1),0,0 !== a ? "inherit" : "hidden",0 === e ? "hidden" : "inherit"),
                s.xs0 = "inherit",
                n._overwriteProps.push(s.n),
        ...
        var Bt = function(t, e) {
            ...
            t.removeProperty(e.replace(z, "-$1").toLowerCase())) : t.removeAttribute(e))
        }
          , Ut = function(t) {
        ...
        xt("className", {
            parser: function(t, e, n, s, o, a, l) {
                ...
                if (o = s._classNamePT = new Rt(t,n,0,0,o,2),
                o.setRatio = Ut,
                o.pr = -11,
                i = !0,
                o.b = d,
        ...
        u._onInitTween = function(t, e, a) {
            ...
            if (c && "" === b.zIndex && (u = Z(t, "zIndex", r),
            ("auto" === u || "" === u) && this._addLazySet(b, "zIndex", 0)),
            "string" == typeof e && (R = b.cssText,
            u = J(t, r),
            b.cssText = R + ";" + e,
            u = tt(t, u, J(t)).difs,
            ...
            this._transformType) {
                ...
                zt ? f && (c = !0,
                "" === b.zIndex && (v = Z(t, "zIndex", r),
                ("auto" === v || "" === v) && this._addLazySet(b, "zIndex", 0)),
                d && this._addLazySet(b, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (x ? "visible" : "hidden"))) : b.zoom = 1,
                m = p; m && m._next; )
                    m = m._next;
        ...
        u.parse = function(t, e, i, s) {
            ...
            for (o in e)
                p = e[o],
                a = l[o],
                a ? i = a.parse(t, p, o, this, i, s, e) : (f = Z(t, o, r) + "",
                R = "string" == typeof p,
                "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || R && T.test(p) ? (R || (p = ht(p),
                p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                i = _t(_, o, f, p, !0, "transparent", i, 0, s)) : R && M.test(p) ? i = _t(_, o, f, p, !0, null, i, 0, s) : (u = parseFloat(f),
                d = u || 0 === u ? f.substr((u + "").length) : "",
                ("" === f || "auto" === f) && ("width" === o || "height" === o ? (u = nt(t, o, r),
                d = "px") : "left" === o || "top" === o ? (u = K(t, o, r),
                ...
                p = p.substr(2),
                c *= parseFloat(p),
                m = p.replace(y, "")) : (c = parseFloat(p),
                m = R ? p.replace(y, "") : ""),
                "" === m && (m = o in n ? n[o] : d),
                p = c || 0 === c ? (g ? c + u : c) + m : e[o],
                d !== m && "" !== m && (c || 0 === c) && u && (u = $(t, o, u, d),
                "%" === m ? (u /= $(t, o, 100, "%") / 100,
                e.strictUnits !== !0 && (f = u + "%")) : "em" === m || "rem" === m || "vw" === m || "vh" === m ? u /= $(t, o, 1, m) : "px" !== m && (c = $(t, o, c, m),
                m = "px"),
                g && (c || 0 === c) && (p = c + u + m)),
                g && (c += u),
                !u && 0 !== u || !c && 0 !== c ? void 0 !== _[o] && (p || p + "" != "NaN" && null != p) ? (i = new Rt(_,o,c || u || 0,0,i,(-1),o,(!1),0,f,p),
                i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : f) : q("invalid " + o + " tween value: " + e[o]) : (i = new Rt(_,o,u,c - u,i,0,o,h !== !1 && ("px" === m || "zIndex" === o),0,f,p),
                i.xs0 = m))),
        ...
        var Wt = function(t, e, i) {
            ...
            if (t.slice)
                ...
                r = n.length; --r > -1; )
                    ...
                    s.style && (e.push(J(s)),
                    i && i.push(s)),
                    1 !== o && 9 !== o && 11 !== o || !s.childNodes.length || Wt(s, e, i)
        };
    ...
    var t = document.documentElement
      ...
      , n = _gsScope._gsDefine.plugin({
        ...
        set: function(t) {
            ...
            this.x < 0 && (this.x = 0),
            this.y < 0 && (this.y = 0),
            this._autoKill && (!this.skipX && (o > 7 || o < -7) && n < i(this._target, "x") && (this.skipX = !0),
            !this.skipY && (s > 7 || s < -7) && r < i(this._target, "y") && (this.skipY = !0),
...
function(t, e, i, n) {
    ...
    t.fn.extend({
        onCSSAnimationEnd: function(e) {
            var i = t(this).eq(0);
            return i.one("webkitAnimationEnd mozAnimationEnd oAnimationEnd oanimationend animationend", e),
            ("" != s || "animation"in r) && "0s" != i.css(s + "animation-duration") || e(),
            this
        },
        onCSSTransitionEnd: function(e) {
            var i = t(this).eq(0);
            return i.one("webkitTransitionEnd mozTransitionEnd oTransitionEnd otransitionend transitionend", e),
            ("" != o || "transition"in r) && "0s" != i.css(o + "transition-duration") || e(),
            this
        }
    })
        ...
        var s = i(1)
          ...
          , u = function() {
            function t(e, i) {
                r(this, t),
                this.options = (0,
                s.extend)(Object.create(l), i),
                this.elements = (0,
                s.getElements)(e).map(a["default"]),
                this.running = !1
            }
            return t.prototype.once = function() {
                var t = this;
                return (0,
                s.each)(this.elements, function(e) {
            ...
            t.prototype.start = function() {
                ...
                (0,
                s.each)(this.elements, function(t) {
                    return t.init()
                }),
            ...
            t.prototype.text = function(t) {
                var e = this;
                return (0,
                s.each)(this.elements, function(i) {
                    i.text(t(i.value)),
                    e.running || i.write()
                }),
                this
        ...
        var o = i(1)
          , a = function() {
            ...
            t.prototype.render = function() {
                ...
                return e.length ? (0,
                o.mapString)(this.value, function(n, r) {
                    return i.indexOf(n) > -1 ? n : t.bitmap[r] ? (0,
                    o.sample)(e) : n
                }) : this.value
            }
            ,
            t.prototype.decay = function() {
                for (var t = arguments.length <= 0 || void 0 === arguments[0] ? 1 : arguments[0]; t--; ) {
                    var e = (0,
                    o.getTruthyIndices)(this.bitmap);
                    this.bitmap[(0,
                    o.sample)(e)] = 0
                }
                return this
          ...
          , l = function(t) {
            ...
            e.prototype.write = function(t) {
                return this.element.textContent = this.render(t),
                this
            }
            ,
            e
            ...
            function g() {
                ...
                i) {
                    if (void 0 === w)
                        return h(b);
                    if (P)
                        return w = setTimeout(p, e),
                        n(b)
                }
                return void 0 === w && (w = setTimeout(p, e)),
                x
            }
            var _, v, y, x, w, b, T = 0, z = !1, P = !1, O = !0;
    ...
    n.prototype.mapping = function() {
        ...
        e = 0; e < this.map.length; e++) {
            ...
            case "scenario-sync":
                ...
                u = void 0 !== r["data-async"] ? s.startAt : s.startAt + s.duration,
